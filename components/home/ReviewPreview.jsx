      ...
      <div className="max-w-wide mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {reviews.map((review) => (
            <div
              key={review.id}
              className="bg-cream dark:bg-dm-bg rounded-card p-6 hover:shadow-warm-md transition-all duration-300"
            >
              {/* 별점 */}
              ...
              {/* 리뷰 내용 */}
              <p className="font-body text-caption text-chocolate-light dark:text-neutral-300 leading-relaxed mb-4 line-clamp-3">
                &quot;{review.content}&quot;
              </p>

              {/* 리뷰 정보 */}
              <div className="border-t border-neutral-200 dark:border-dm-border pt-3">
